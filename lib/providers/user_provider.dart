...
import 'package:servicios_modelos/services/services.dart';

final userServiceProvider = Provider<UserService>((ref){
  return UserService();
});

final hairColorProvider = FutureProvider<List<String>>((ref){
...
final colorSeleccionadoProvider = NotifierProvider<ColorSeleccionado, String?>(ColorSeleccionado.new);

final usersProvider = FutureProvider<List<User>>((ref){
  final service = ref.watch(userServiceProvider);
  final color = ref.watch(colorSeleccionadoProvider);
  return color==null? service.getUsers():service.getUsersByHairColor(color);
});
